...
TRAINED_NO_JSON_FACILITIES: list[tuple[str, str]] = [
    ("Boeing_Satellite", "卫星工厂（多功能分区 / 卫星工厂-波音卫星）"),
    ("MPPF", "加工厂房（MPPF / 多载荷处理厂房）"),
    ("SLC", "移动发射平台+发射塔（SLC3-发射塔+LC39-移动发射台）"),
    ("boeing", "飞机工厂（总装车间+部装车间 / 波音飞机主厂房+相邻机身辅助厂）"),
    ("factory", "飞机工厂（沃斯堡 / 沃斯堡空军4号-飞机工厂）"),
    ("hanger", "发射场运载火箭集成车库（40号发射场机库）"),
    ("lcc", "发射控制中心（LCC）"),
    ("lob", "发射控制中心（SLC3发射操作楼）"),
    ("maf", "加工厂房（MAF / 加工厂房）"),
    ("ocb", "部装车间（O&C操作测试大楼）"),
    ("sspf", "部装车间（SSPF空间系统处理设施）"),
    ("vab", "总装车间（VAB总装大楼）"),
    ("Hangar", "机场机库（埃格林空军基地一号机库）"),
    ("TWA", "机场机库（费城国际机场TWA维修机库）"),
    ("ligen", "机场机库（华盛顿里根国家机场机库）"),
    ("tesla", "机械制造设施（Tesla）"),
    ("yjc", "冶金-钢铁厂（冶金厂）"),
]
...
FACILITY_CATEGORIES: list[tuple[str, str, list[tuple[str, str, bool]]]] = [
    (
        ...
        [
            ...
            ("Boeing_Satellite", "卫星工厂（多功能分区 / 卫星工厂-波音卫星）", False),
            ("MPPF", "加工厂房（MPPF / 多载荷处理厂房）", False),
            ("SLC", "移动发射平台+发射塔（SLC3-发射塔+LC39-移动发射台）", False),
            ("boeing", "飞机工厂（总装车间+部装车间 / 波音飞机主厂房+相邻机身辅助厂）", False),
            ("factory", "飞机工厂（沃斯堡 / 沃斯堡空军4号-飞机工厂）", False),
            ("hanger", "发射场运载火箭集成车库（40号发射场机库）", False),
            ("lcc", "发射控制中心（LCC）", False),
            ("lob", "发射控制中心（SLC3发射操作楼）", False),
            ("maf", "加工厂房（MAF / 加工厂房）", False),
            ("ocb", "部装车间（O&C操作测试大楼）", False),
            ("sspf", "部装车间（SSPF空间系统处理设施）", False),
            ("vab", "总装车间（VAB总装大楼）", False),
            ("Hangar", "机场机库（埃格林空军基地一号机库）", False),
            ("TWA", "机场机库（费城国际机场TWA维修机库）", False),
            ("ligen", "机场机库（华盛顿里根国家机场机库）", False),
        ],
    ),
    (
        "机械制造",
        ...
        [
            ...
            ("frymaster_corporation", "机械-总装（Frymaster Corporation 机械总装区）", False),
            ("gleason_cutting_tools_corporation", "机械-机械加工（Gleason Cutting Tools Corporation）", False),
            ("harbison_fischer", "机械-部装（Harbison Fischer 机械部装区）", False),
            ("tesla", "机械制造设施（Tesla）", False),
        ],
    ),
    (
        "冶金",
        ...
        [
            ...
            ("alcoa", "冶金-电解厂（Alcoa Warrick Operations）", False),
            ("materion_buffalo", "冶金-金精炼（Materion Electronic Materials Buffalo）", False),
            ("materion_newton", "冶金-钽精炼（Materion Electronic Materials Newton）", False),
            ("warrick_power_plant", "冶金-发电厂（Warrick Power Plant）", False),
            ("yjc", "冶金-钢铁厂（冶金厂）", False),
        ],
    ),
]
